		...
		<div id="post-<?php the_ID(); ?>" <?php post_class( array( 'block','w4' ) ); ?> style="background-image:url(<?php philomina_featuredBgLarge( $post ); ?>)">
			<div class="inside_block">
				<h1><?php the_title(); ?></h1>
				<button class="continue"><?php _e( "Continue", "philomina" ) ?></button>
			</div>
		</div>
		</a>
		<?php
